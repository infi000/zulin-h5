 ...
 * 获取列表
 */
export const serviceGetTableList = (params: TQuery) => fetch('/index.php/WebApi/User/myincome', { params });
 ...
 * @returns
 */
export const serviceGetDetail = (params: any) => fetch('/index.php/WebApi/User/userincomestics', { params});
 ...
 * @returns
 */
 export const serviceGetIncomeStatics = (params: any) => fetch('/index.php/WebApi/User/myincomestics', { params});
